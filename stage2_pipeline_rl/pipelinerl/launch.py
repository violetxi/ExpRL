...
# TapeAgents is installed as a dependency; only prepend a path to PYTHONPATH if
# the user points TAPEAGENTS_PATH at a local source checkout.
_tapeagents_path = os.environ.get("TAPEAGENTS_PATH")
if _tapeagents_path:
    os.environ["PYTHONPATH"] = _tapeagents_path + os.pathsep + os.environ.get("PYTHONPATH", "")
