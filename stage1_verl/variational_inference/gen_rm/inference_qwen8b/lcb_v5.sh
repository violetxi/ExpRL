#!/bin/bash
#SBATCH --job-name=judge_calibration_lcb_v5_qwen8b
...
###### Smoke test: first 10 LCB v6 problems, end-to-end ######
...
data.output_path=${HF_NAMESPACE:-violetxi}/judge_calibration_lcb_v5_qwen8b \
data.chunk_output_dir=./chunks_judge_calibration_lcb_v5_qwen8b \
