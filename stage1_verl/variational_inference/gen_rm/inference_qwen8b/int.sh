#!/bin/bash
#SBATCH --job-name=int_qwen4b_instruct_stage1-1
...
data.output_path=${HF_NAMESPACE:-violetxi}/judge_calibration_int_qwen8b \
data.chunk_output_dir=./chunks_judge_calibration_int_qwen8b \
