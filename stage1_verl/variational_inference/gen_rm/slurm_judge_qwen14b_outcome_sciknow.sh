#!/bin/bash
#SBATCH --job-name=judge_qwen14b_sciknow
...
# Usage:
#   sbatch slurm_judge_qwen14b_outcome_sciknow.sh [mcq|oe|all]
...
declare -A SCIKNOW_OUTPUT=(
    [mcq]="${HF_NAMESPACE:-violetxi}/Qwen14b-NoThink-Judge-sciknoweval-mcq-l3-loose-qwen8b-multi-ref"
    [oe]="${HF_NAMESPACE:-violetxi}/Qwen14b-NoThink-Judge-sciknoweval-oe-v1-qwen8b-multi-ref"
)
