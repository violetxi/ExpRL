#!/bin/bash
#SBATCH --job-name=grpo_set1_cont_n32
...
local_dir=checkpoints/exp_stage2_qwen3-4b_onpolicy_distill/sft/
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=${HF_NAMESPACE:-violetxi}/exp-stage1-sft \
    +actor_rollout_ref.model.revision=main \
    ...
    trainer.project_name='verl_exp_stage2_qwen4b_instruct' \
