#!/bin/bash
#SBATCH --job-name=hmmt_qwen8b_dense_outcome_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage1_qwen8b_dense_outcome \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage1_qwen8b_dense_outcome \
