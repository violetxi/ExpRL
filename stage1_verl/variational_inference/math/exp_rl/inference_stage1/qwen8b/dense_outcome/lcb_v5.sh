#!/bin/bash
#SBATCH --job-name=lcb_v5_qwen8b_dense_outcome_stage1
...
###### LiveCodeBench v5 — Dense Outcome (exp_rl_all_domains_stage1_qwen8b_dense_outcome)
...
data.output_path=${HF_NAMESPACE:-violetxi}/lcb_v5_stage1_qwen8b_dense_outcome \
data.chunk_output_dir=./chunks_lcb_v5_stage1_qwen8b_dense_outcome \
