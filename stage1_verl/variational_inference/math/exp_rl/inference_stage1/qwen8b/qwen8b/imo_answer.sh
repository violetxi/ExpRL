#!/bin/bash
#SBATCH --job-name=imo_qwen8b_no-thinking_stage1
...
###### IMO AnswerBench — Base Qwen3-8B (no thinking)
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage1_qwen8b_no-thinking \
data.chunk_output_dir=./chunks_imo-answerbench_stage1_qwen8b_no-thinking \
