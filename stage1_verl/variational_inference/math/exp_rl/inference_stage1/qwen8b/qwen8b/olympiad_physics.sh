#!/bin/bash
#SBATCH --job-name=olympiad_physics_qwen8b_no-thinking_stage1
...
###### OlympiadBench-OE Physics (OE_TO_physics_en_COMP) — Qwen3-8B (no thinking)
...
data.output_path=${HF_NAMESPACE:-violetxi}/olympiad_physics_stage1_qwen8b_no-thinking \
data.chunk_output_dir=./chunks_olympiad_physics_stage1_qwen8b_no-thinking \
