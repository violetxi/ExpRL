#!/bin/bash
#SBATCH --job-name=lcb_v5_qwen8b_no-thinking_stage1
...
###### LiveCodeBench v5 — Base Qwen3-8B (no thinking)
...
data.output_path=${HF_NAMESPACE:-violetxi}/lcb_v5_stage1_qwen8b_no-thinking \
data.chunk_output_dir=./chunks_lcb_v5_stage1_qwen8b_no-thinking \
