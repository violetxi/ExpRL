#!/bin/bash
#SBATCH --job-name=hmmt_qwen8b_no-thinking_stage1
...
###### HMMT Nov 2025 — Base Qwen3-8B (no thinking)
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage1_qwen8b_no-thinking \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage1_qwen8b_no-thinking \
