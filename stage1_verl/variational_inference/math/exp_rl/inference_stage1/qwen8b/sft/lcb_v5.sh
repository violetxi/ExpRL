#!/bin/bash
#SBATCH --job-name=lcb_v5_qwen8b_sft_stage1
...
###### LiveCodeBench v5 — SFT (exp_rl_stage1_qwen8b_sft, main = global_step_204)
...
data.output_path=${HF_NAMESPACE:-violetxi}/lcb_v5_stage1_qwen8b_sft \
data.chunk_output_dir=./chunks_lcb_v5_stage1_qwen8b_sft \
