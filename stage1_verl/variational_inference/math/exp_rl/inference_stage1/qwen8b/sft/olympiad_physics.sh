#!/bin/bash
#SBATCH --job-name=olympiad_physics_qwen8b_sft_stage1
...
###### OlympiadBench-OE Physics (OE_TO_physics_en_COMP) — SFT (exp_rl_stage1_qwen8b_sft, main = global_step_204)
...
data.output_path=${HF_NAMESPACE:-violetxi}/olympiad_physics_stage1_qwen8b_sft \
data.chunk_output_dir=./chunks_olympiad_physics_stage1_qwen8b_sft \
