#!/bin/bash
#SBATCH --job-name=imo_qwen8b_sft_stage1
...
###### IMO AnswerBench — SFT (exp_rl_stage1_qwen8b_sft, main = global_step_204)
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage1_qwen8b_sft \
data.chunk_output_dir=./chunks_imo-answerbench_stage1_qwen8b_sft \
