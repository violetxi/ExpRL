#!/bin/bash
#SBATCH --job-name=lcb_v5_qwen8b_grpo_stage1
...
###### LiveCodeBench v5 — GRPO (exp_rl_all_domains_stage1_qwen8b_grpo)
test_path=data/instruct/livecodebench_v5/test.parquet
...
data.output_path=${HF_NAMESPACE:-violetxi}/lcb_v5_stage1_qwen8b_grpo \
data.chunk_output_dir=./chunks_lcb_v5_stage1_qwen8b_grpo \
