#!/bin/bash
#SBATCH --job-name=imo_qwen8b_grpo_stage1
...
###### IMO AnswerBench — GRPO (exp_rl_all_domains_stage1_qwen8b_grpo)
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage1_qwen8b_grpo \
data.chunk_output_dir=./chunks_imo-answerbench_stage1_qwen8b_grpo \
