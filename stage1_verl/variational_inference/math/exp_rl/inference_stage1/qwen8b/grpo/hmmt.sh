#!/bin/bash
#SBATCH --job-name=hmmt_qwen8b_grpo_stage1
...
###### HMMT Nov 2025 — GRPO (exp_rl_all_domains_stage1_qwen8b_grpo)
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage1_qwen8b_grpo \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage1_qwen8b_grpo \
