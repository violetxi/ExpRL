#!/bin/bash
#SBATCH --job-name=hmmt_qwen8b_opsd_stage1
...
###### HMMT Nov 2025 — OPSD (exp_rl_all_domains_stage1_qwen8b_opsd)
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage1_qwen8b_opsd \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage1_qwen8b_opsd \
