#!/bin/bash
#SBATCH --job-name=lcb_v5_qwen8b_opsd_stage1
...
###### LiveCodeBench v5 — OPSD (exp_rl_all_domains_stage1_qwen8b_opsd)
...
data.output_path=${HF_NAMESPACE:-violetxi}/lcb_v5_stage1_qwen8b_opsd \
data.chunk_output_dir=./chunks_lcb_v5_stage1_qwen8b_opsd \
