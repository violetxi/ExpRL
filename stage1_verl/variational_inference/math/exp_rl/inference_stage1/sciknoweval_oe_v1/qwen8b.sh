#!/bin/bash
#SBATCH --job-name=sciknow_oe_v1_qwen8b_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/sciknoweval_oe_v1_stage1_qwen8b \
data.chunk_output_dir=./chunks_sciknoweval_oe_v1_stage1_qwen8b \
