#!/bin/bash
#SBATCH --job-name=pope_pr_gppo_stage1
...
model.path=${HF_NAMESPACE:-violetxi}/exp_stage1_qwen3-4b_pr_gppo \
model.revision=main \
data.path=$test_path \
...
data.output_path=${HF_NAMESPACE:-violetxi}/pope_hard_stage1_pr_gppo \
data.chunk_output_dir=./chunks_pope_hard_stage1_pr_gppo \
