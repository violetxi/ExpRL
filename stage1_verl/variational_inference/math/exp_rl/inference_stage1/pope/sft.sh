...
model.path=${HF_NAMESPACE:-violetxi}/exp-stage1-sft \
model.revision=main \
data.path=$test_path \
...
data.output_path=${HF_NAMESPACE:-violetxi}/pope_hard_stage1_sft \
data.chunk_output_dir=./chunks_pope_hard_stage1_sft \
