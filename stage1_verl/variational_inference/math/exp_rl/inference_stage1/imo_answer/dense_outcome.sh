#!/bin/bash
#SBATCH --job-name=imo_dense_outcome_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage1_dense_outcome \
data.chunk_output_dir=./chunks_imo-answerbench_stage1_dense_outcome \
