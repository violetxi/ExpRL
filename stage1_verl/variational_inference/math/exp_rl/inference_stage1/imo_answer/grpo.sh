#!/bin/bash
#SBATCH --job-name=imo_grpo_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage1_grpo \
data.chunk_output_dir=./chunks_imo-answerbench_stage1_grpo \
