#!/bin/bash
#SBATCH --job-name=imo_answer_pr_e_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage1_pr_e \
data.chunk_output_dir=./chunks_imo-answerbench_stage1_pr_e \
