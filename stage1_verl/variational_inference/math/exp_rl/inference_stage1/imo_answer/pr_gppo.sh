#!/bin/bash
#SBATCH --job-name=imo_pr_gppo_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage1_pr_gppo \
data.chunk_output_dir=./chunks_imo-answerbench_stage1_pr_gppo \
