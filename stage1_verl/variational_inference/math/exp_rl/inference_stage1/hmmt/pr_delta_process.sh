#!/bin/bash
#SBATCH --job-name=hmmt_pr_delta_process_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage1_pr_delta_process \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage1_pr_delta_process \
