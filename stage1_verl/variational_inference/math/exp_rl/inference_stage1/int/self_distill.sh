#!/bin/bash
#SBATCH --job-name=int_self_distill_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/int_stage1_self_distill \
data.chunk_output_dir=./chunks_int_stage1_self_distill \
