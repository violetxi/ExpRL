#!/bin/bash
#SBATCH --job-name=self_distill_stage2_imo_answer
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage2_self_distill_ckpt500 \
data.chunk_output_dir=./chunks_imo-answerbench_stage2_self_distill_ckpt500 \
