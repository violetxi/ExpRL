#!/bin/bash
#SBATCH --job-name=sft_stage2_imo_answer
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage2_sft_ckpt500 \
data.chunk_output_dir=./chunks_imo-answerbench_stage2_sft_ckpt500 \
