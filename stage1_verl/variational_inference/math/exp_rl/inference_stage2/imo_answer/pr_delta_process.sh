#!/bin/bash
#SBATCH --job-name=pr_delta_process_stage2_imo_answer
...
data.output_path=${HF_NAMESPACE:-violetxi}/imo-answerbench_stage2_pr_delta_process_ckpt500 \
data.chunk_output_dir=./chunks_imo-answerbench_stage2_pr_delta_process_ckpt500 \
