#!/bin/bash
#SBATCH --job-name=int_pr_delta_process_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/int_stage2_pr_delta_process_ckpt500 \
data.chunk_output_dir=./chunks_int_stage2_pr_delta_process_ckpt500 \
