#!/bin/bash
#SBATCH --job-name=int_dense_outcome_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/int_stage2_dense_outcome_ckpt500 \
data.chunk_output_dir=./chunks_int_stage2_dense_outcome_ckpt500 \
