#!/bin/bash
#SBATCH --job-name=sft_stage2_hmmt
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage2_sft_ckpt500 \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage2_sft_ckpt500 \
