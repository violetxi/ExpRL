#!/bin/bash
#SBATCH --job-name=self_distill_stage2_hmmt
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage2_self_distill_ckpt500 \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage2_self_distill_ckpt500 \
