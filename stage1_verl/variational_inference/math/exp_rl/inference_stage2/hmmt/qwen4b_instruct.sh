#!/bin/bash
#SBATCH --job-name=hmmt_qwen4b_instruct_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/hmmt-nov-2025_stage1_qwen4b_instruct_ckpt500 \
data.chunk_output_dir=./chunks_hmmt-nov-2025_stage1_qwen4b_instruct_ckpt500 \
