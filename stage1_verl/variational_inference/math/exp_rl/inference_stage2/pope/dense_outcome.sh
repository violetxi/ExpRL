#!/bin/bash
#SBATCH --job-name=pope_dense_outcome_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/pope_hard_stage2_dense_outcome_ckpt500 \
data.chunk_output_dir=./chunks_pope_hard_stage2_dense_outcome_ckpt500 \
