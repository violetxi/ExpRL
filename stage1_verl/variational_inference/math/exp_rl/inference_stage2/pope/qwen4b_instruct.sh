#!/bin/bash
#SBATCH --job-name=pope_qwen4b_instruct_stage1
...
data.output_path=${HF_NAMESPACE:-violetxi}/pope_hard_stage1_qwen4b_instruct_ckpt500 \
data.chunk_output_dir=./chunks_pope_hard_stage1_qwen4b_instruct_ckpt500 \
