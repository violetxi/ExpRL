#!/bin/bash
#SBATCH --job-name=opsd_qwen8b_all_domains
...
local_dir=checkpoints/grpo_qwen8b_all_domains/self_distill_lr1e-7
...
python3 -m verl.trainer.main_onpolicy_distill \
    ...
    trainer.project_name='verl_exp_rl_qwen8b_all_domains' \
