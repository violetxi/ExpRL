...
local_dir=checkpoints/exp_rl_qwen3-4b_instruct-2507/pr_end/

set -x

python3 -m verl.trainer.main_rl_genrm \
    algorithm.adv_estimator=group_process_end \
    ...
    trainer.experiment_name='pr_end' \
