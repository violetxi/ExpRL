...
# Stage-1 baseline: sparse-reward GRPO (binary final-answer reward) on the
# mid-training prompt mixture. Single node, 8 GPUs (verl manages Ray locally).
...
local_dir=checkpoints/pope_int_qwen3-4b/grpo
