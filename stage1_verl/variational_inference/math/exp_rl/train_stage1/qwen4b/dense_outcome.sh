...
local_dir=checkpoints/pope_int_qwen3-4b/dense_outcome/
...
python3 -m verl.trainer.main_rl_genrm \
    ...
    +custom_reward_function.prompt_template_path=verl/utils/prompt_templates/math_likelihood_judge.py \
