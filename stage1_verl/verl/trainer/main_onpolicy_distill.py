...
"""
This is used to simply compute the logp of the model
"""
...
from verl.trainer.ppo.ray_onpolicy_distill import RayOnpolicyDistill
from verl.trainer.ppo.reward import load_reward_manager
from verl.utils.device import is_cuda_available
from verl.utils.import_utils import load_extern_type


@hydra.main(config_path="config", config_name="onpolicy_distill", version_base=None)
def main(config):
    """Main entry point for On-Policy Distillation training with Hydra configuration management.
