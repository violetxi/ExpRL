...
from verl.trainer.ppo.ray_trainer_proof import RayProofTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        if config.actor_rollout_ref.rollout.mode == "async":
            raise NotImplementedError("main_rl_proof only supports synchronous rollout.mode")
